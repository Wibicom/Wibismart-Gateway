...
//  console.log('[BLE] found peripheral:\n' + peripheral + '\n\n\n\n\n');
  ...
  if((peripheral.address == 'b0:b4:48:e4:bf:03' || peripheral.address == '11:22:33:44:55:66' || peripheral.address == 'b0:b4:48:e4:9c:80') && (peripheral.advertisement['localName'] != null && peripheral.advertisement['localName'].indexOf('Enviro') > -1)) {
